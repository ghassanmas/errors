## The purpose of this repo is to illustrate 3 types of approach of handling errors based on [error-handling-workshop](https://github.com/foundersandcoders/error-handling-workshop).
